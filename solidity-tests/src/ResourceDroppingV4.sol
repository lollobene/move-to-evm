...
contract ResourceDroppingV4 is IProtectionLayerProtectorV2 {
    ...
    function protect(
        ...
        assert(_signer != address(0)); // , "Invalid signer address");
        assert(_protected_contract == msg.sender); // , "Invalid protected_contract address");
        flag = true;
