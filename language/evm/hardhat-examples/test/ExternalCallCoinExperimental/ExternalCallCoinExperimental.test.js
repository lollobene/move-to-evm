...
const ExternalCallCoinExperimental = artifacts.require('ExternalCallCoinExp');

contract('ExternalCallCoinExperimental', function (accounts) {
    ...
    before(async function () {
        ...
        this.externalCallcoin = await ExternalCallCoinExperimental.new();
