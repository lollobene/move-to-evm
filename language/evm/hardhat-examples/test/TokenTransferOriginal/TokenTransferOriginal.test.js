...
const TokenTransferOriginal = artifacts.require('TokenTransferOriginal');

contract('TokenTransferOriginal', function (accounts) {
    ...
    before(async function () {
        ...
        this.tokenTransfer = await TokenTransferOriginal.new({
            from: deployer,
        });
