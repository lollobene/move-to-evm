...
contract('ProtectionLayerCosts', function (accounts) {
    ...
    let protectionLayerHelperABI = ['function getAndSink(address signer)'];
    ...
    describe('Protection layer gas costs', function () {
        ...
        it('Calling protection layer on external contrat on get and sink functions', async function () {
            let getAndSinkEncoding =
