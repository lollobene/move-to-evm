...
contract('ProtectionLayerCosts', function (accounts) {
    ...
    let protectionLayerHelperABI = ['function removeAndSink(address signer)'];
    ...
    describe('Protection layer gas costs', function () {
        ...
        it('Calling protection layer on external contrat on remove and sink functions', async function () {
            let removeAndSinkEncoding =
