...
module Evm::basic_nft_original {
    ...
    fun init_tokendata(
        ...
        let account = &sign(sender());
        assert!(
            !exists<TokenData>(sender()),
    ...
    fun check_approval(
        ...
        assert!(
            transfer_approval.approved == sender(),
            EINVALID_APPROVAL
        );
    ...
    #[callable(sig=b"withdraw(uint64) returns (Token)")]
    public fun withdraw(
        id: u64,
    ...
    #[callable(sig=b"deposit(address, Token)")]
